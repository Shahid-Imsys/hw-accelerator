...
--  Date of Generation : Mon May 23 15:57:30 CEST 2022                 
--                                                                     
-----------------------------------------------------------------------
--   --------------------------------------------------------------     
...
entity generic_vhd_SNPS_RF_SP_UHS_64x64 is
  generic (
        words            : integer            := 64;
        addrbits         : integer            := 6;
        bits             : integer            := 64;
...
end generic_vhd_SNPS_RF_SP_UHS_64x64;

architecture behav of generic_vhd_SNPS_RF_SP_UHS_64x64 is
...
SIGNAL  ADR_old : std_logic_vector(5 downto 0);
...
process( CLK, D, BC0, BC1, BC2, TEST_RNM, TEST1, t3_me)
   ...
   VARIABLE ADRlatched : std_logic_vector(5 downto 0);
...
entity SNPS_RF_SP_UHS_64x64 is
...
end SNPS_RF_SP_UHS_64x64;

architecture behaviour of SNPS_RF_SP_UHS_64x64 is

component generic_vhd_SNPS_RF_SP_UHS_64x64
  generic (
        words             : integer                := 64;
        addrbits          : integer                := 6;
        bits              : integer                := 64;
...
SIGNAL ADR_buf : STD_LOGIC_VECTOR(5 downto 0) := (others=>'0');
SIGNAL ADR_mout : STD_LOGIC_VECTOR(5 downto 0) := (others=>'0');
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for u0 : generic_vhd_SNPS_RF_SP_UHS_64x64 use entity work.generic_vhd_SNPS_RF_SP_UHS_64x64(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  u0 : generic_vhd_SNPS_RF_SP_UHS_64x64
  generic map (
        NW                     => 64, 
        NADDR                  => 6,
        rmbits                 => 3,
...
configuration conf_SNPS_RF_SP_UHS_64x64_behaviour of SNPS_RF_SP_UHS_64x64 is
for behaviour
end for;
end conf_SNPS_RF_SP_UHS_64x64_behaviour;
