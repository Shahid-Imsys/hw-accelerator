...
--  Date of Generation : Wed May 04 16:40:13 CEST 2022                 
--                                                                     
-----------------------------------------------------------------------
--   --------------------------------------------------------------     
...
entity generic_vhd_SNPS_SP_HD_2Kx80 is
  generic (
        words            : integer            := 2048;
        addrbits         : integer            := 11;
        bits             : integer            := 80;
...
end generic_vhd_SNPS_SP_HD_2Kx80;

architecture behav of generic_vhd_SNPS_SP_HD_2Kx80 is
...
end SNPS_SP_HD_2Kx80;

architecture behaviour of SNPS_SP_HD_2Kx80 is

component generic_vhd_SNPS_SP_HD_2Kx80
  generic (
        words             : integer                := 2048;
        addrbits          : integer                := 11;
        bits              : integer                := 80;
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_2Kx80 use entity work.generic_vhd_SNPS_SP_HD_2Kx80(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_2Kx80
  generic map (
        NW                     => 2048, 
        NADDR                  => 11,
        rmbits                 => 3,
...
configuration conf_SNPS_SP_HD_2Kx80_behaviour of SNPS_SP_HD_2Kx80 is
for behaviour
end for;
end conf_SNPS_SP_HD_2Kx80_behaviour;
