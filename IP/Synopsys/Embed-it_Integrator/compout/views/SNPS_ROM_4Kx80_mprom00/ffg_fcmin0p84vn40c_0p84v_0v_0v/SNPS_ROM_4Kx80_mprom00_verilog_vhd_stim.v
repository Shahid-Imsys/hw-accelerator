...
`endif
  ...
  setuphold("ADR","Tac",$realtobits(0.152),0,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 39;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ADR   --- \n\n", $time, test_num);
  setuphold("ADR","Tac",$realtobits(0.152),0,1, 2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 40;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ADR   --- \n\n", $time, test_num);
  setuphold("ADR","Tcax",$realtobits(0.046),1,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 41;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ADR   --- \n\n", $time, test_num);
  setuphold("ADR","Tcax",$realtobits(0.046),1,1, 2'b01);
  @(negedge CLK);
  ...
  setuphold("ME","Tmc",$realtobits(0.064),0,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 43;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ME   --- \n\n", $time, test_num);
  setuphold("ME","Tmc",$realtobits(0.064),0,1, 2'b01);
  @(negedge CLK);
  @(negedge CLK);
  ADR = 0;
  $display ("\n#######################################################################");
  ...
  setuphold("ME_LS_H","Tmc",$realtobits(0.064),0,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 46;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ME  when LS active  --- \n\n", $time, test_num);
  setuphold("ME_LS_H","Tmc",$realtobits(0.064),0,1, 2'b01);
  @(negedge CLK);
  LS = 1'b0;
  @(negedge CLK);
  @(negedge CLK);
  ...
  setuphold("ME_X","Tmc",$realtobits(0.064),0,1, 2'b01);
  @(negedge CLK);
  @(negedge CLK);
  ADR = 0;
  @(negedge CLK);
  ...
  setuphold("ME","Tcmx",$realtobits(0.029),1,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 51;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ME   --- \n\n", $time, test_num);
  setuphold("ME","Tcmx",$realtobits(0.029),1,1, 2'b01);
  @(negedge CLK);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 52;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ME  when LS active  --- \n\n", $time, test_num);
  setuphold("ME_LS_H","Tcmx",$realtobits(0.029),1,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 53;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ME   when LS active  --- \n\n", $time, test_num);
  setuphold("ME_LS_H","Tcmx",$realtobits(0.029),1,1, 2'b01);
  @(negedge CLK);
  LS = 1'b0;
  @(negedge CLK);
  ...
  setuphold("ME_X","Tcmx",$realtobits(0.029),1,1, 2'b01);
  @(negedge CLK);

  $display ("\n#######################################################################");
  test_num = 57;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on LS   --- \n\n", $time, test_num);
  setuphold("LS","Tflsc",$realtobits(0.025),0,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 58;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on LS   --- \n\n", $time, test_num);
  setuphold("LS","Tflsc",$realtobits(0.025),0,1, 2'b01);
  @(negedge CLK);
  @(negedge CLK);
  ADR = 0;
  $display ("\n#######################################################################");
  ...
  setuphold("LS","Tlsx",$realtobits(0.081),1,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 60;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS   --- \n\n", $time, test_num);
  setuphold("LS","Tlsx",$realtobits(0.081),1,1, 2'b01);
  @(negedge CLK);
  ...
  setuphold("TEST1","TT1C",$realtobits(0.152),0,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 62;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST1   --- \n\n", $time, test_num);
  setuphold("TEST1","TT1C",$realtobits(0.152),0,1, 2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 63;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST1   --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(0.808),1,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 64;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1    --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(0.808),1,1, 2'b01);
  @(negedge CLK);

  $display ("\n#######################################################################");
  test_num = 65;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RM[1:0]   --- \n\n", $time, test_num);
  setuphold("RM","Trmc",$realtobits(0.196),0,0, 2'b00);
  @(negedge CLK); 
  $display ("\n#######################################################################");
  test_num = 66;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RM[1:0]    --- \n\n", $time, test_num);
  setuphold("RM","Trmc",$realtobits(0.196),0,1, 2'b01);
  @(negedge CLK); 
  $display ("\n#######################################################################");
  test_num = 67;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RM[1:0]   --- \n\n", $time, test_num);
  setuphold("RM","Tcrmx",$realtobits(0.126),1,0, 2'b00);
  @(negedge CLK); 
  $display ("\n#######################################################################");
  test_num = 68;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RM[1:0]    --- \n\n", $time, test_num);
  setuphold("RM","Tcrmx",$realtobits(0.126),1,1, 2'b01);
  @(negedge CLK); 
  @(negedge CLK); 
  $display ("\n#######################################################################");
  test_num = 69;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RM[3]   --- \n\n", $time, test_num);
  setuphold("RM","Trm3c",$realtobits(0.228),0,0, 2'b00);
  @(negedge CLK); 
  $display ("\n#######################################################################");
  test_num = 70;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RM[3]    --- \n\n", $time, test_num);
  setuphold("RM","Trm3c",$realtobits(0.228),0,1, 2'b01);
  @(negedge CLK); 
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 71;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RM[3]   --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(0.960),1,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 72;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RM[3]    --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(0.960),1,1, 2'b01);
  @(negedge CLK);
  RM = 4'b0011;
  $display ("\n#######################################################################");
  test_num = 73;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RME   --- \n\n", $time, test_num);
  setuphold("RME","Trmec",$realtobits(0.196),0,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 74;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RME    --- \n\n", $time, test_num);
  setuphold("RME","Trmec",$realtobits(0.196),0,1, 2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 75;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RME   --- \n\n", $time, test_num);
  setuphold("RME","Tcrmex",$realtobits(0.126),1,0, 2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 76;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RME    --- \n\n", $time, test_num);
  setuphold("RME","Tcrmx",$realtobits(0.126),1,1, 2'b01);
  @(negedge CLK);
  RM = 4'b0011;
  RME = 1'b0;
