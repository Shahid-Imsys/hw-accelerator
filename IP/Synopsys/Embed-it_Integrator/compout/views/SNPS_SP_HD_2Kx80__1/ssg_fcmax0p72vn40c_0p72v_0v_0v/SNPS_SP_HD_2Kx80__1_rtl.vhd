...
entity generic_vhd_SNPS_SP_HD_2Kx80__1 is
  generic (
        words            : integer            := 2048;
        addrbits         : integer            := 11;
        bits             : integer            := 80;
...
end generic_vhd_SNPS_SP_HD_2Kx80__1;

architecture behav of generic_vhd_SNPS_SP_HD_2Kx80__1 is
...
SIGNAL  ADR_old : std_logic_vector(10 downto 0);
SIGNAL  D_old : std_logic_vector(79 downto 0);
...
process( CLK, D, BC0, BC1, BC2, TEST_RNM, TEST1, t3_me)
   ...
   VARIABLE ADRlatched : std_logic_vector(10 downto 0);
   VARIABLE Dlatched : std_logic_vector(79 downto 0);
...
end SNPS_SP_HD_2Kx80__1;

architecture behaviour of SNPS_SP_HD_2Kx80__1 is

component generic_vhd_SNPS_SP_HD_2Kx80__1
  generic (
        words             : integer                := 2048;
        addrbits          : integer                := 11;
        bits              : integer                := 80;
...
SIGNAL ADR_buf : STD_LOGIC_VECTOR(10 downto 0) := (others=>'0');
SIGNAL ADR_mout : STD_LOGIC_VECTOR(10 downto 0) := (others=>'0');
SIGNAL D_buf : STD_LOGIC_VECTOR(79 downto 0) := (others=>'0');
SIGNAL D_mout : STD_LOGIC_VECTOR(79 downto 0) := (others=>'0');
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_2Kx80__1 use entity work.generic_vhd_SNPS_SP_HD_2Kx80__1(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_2Kx80__1
  generic map (
        NW                     => 2048, 
        NADDR                  => 11,
        rmbits                 => 3,
...
configuration conf_SNPS_SP_HD_2Kx80__1_behaviour of SNPS_SP_HD_2Kx80__1 is
for behaviour
end for;
end conf_SNPS_SP_HD_2Kx80__1_behaviour;
