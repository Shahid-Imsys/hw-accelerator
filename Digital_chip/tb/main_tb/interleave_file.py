...
# cat main_mem_p0.mif | ./mif2bin.py > main_mem_p0.mp
# cat main_mem_p1.mif | ./mif2bin.py > main_mem_p1.mp
# cat test_mem_p0.mif | ./mif2bin.py > test_mem_p0.mp
# cat test_mem_p1.mif | ./mif2bin.py > test_mem_p1.mp
...
# ./mp2coe.py test_mem_p0.mp ; mv out.coe ../../../fpga_synth/gpp/gpp.srcs/sources_1/ip/test_mem_p0/test_mem_p0.coe
# ./mp2coe.py test_mem_p1.mp ; mv out.coe ../../../fpga_synth/gpp/gpp.srcs/sources_1/ip/test_mem_p1/test_mem_p1.coe


# Not needed anymore when mif are generated by Vivado
