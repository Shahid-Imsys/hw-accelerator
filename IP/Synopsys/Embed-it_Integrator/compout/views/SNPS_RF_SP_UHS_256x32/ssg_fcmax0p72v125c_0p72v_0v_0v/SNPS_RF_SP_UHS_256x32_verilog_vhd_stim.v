...
WPULSE = 3'b000;
  ...
  setuphold("LS","Tfls1c",$realtobits(0.312),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 119;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on LS when BC0 = 1 in Write mode  --- \n\n", $time, test_num);
  setuphold("LS","Tfls1c",$realtobits(0.312),0,1,1,2'b10,2'b01,2'b11);
  $display ("\n#######################################################################");
  test_num = 120;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on LS when BC0 = 1 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS","Tfls1c",$realtobits(0.312),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 121;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on LS when BC0 = 1 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS","Tfls1c",$realtobits(0.312),0,1,0,2'b10,2'b01,2'b11);
  $display ("\n#######################################################################");
  test_num = 122;
  ...
  setuphold("D","Tcdx",$realtobits(0.115),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 158;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on D in Read mode  --- \n\n", $time, test_num);
  setuphold("D","Tcdx",$realtobits(0.115),1,1,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 159;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on D in Write mode  When Write Enable Inactive --- \n\n", $time, test_num);
  setuphold("D_WE0","Tcdx",$realtobits(0.115),1,1,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 160;
  ...
  setuphold("D","Tcdx",$realtobits(0.115),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 163;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on D in Write mode  --- \n\n", $time, test_num);
  setuphold("D","Tcdx",$realtobits(0.115),1,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 164;
  ...
  setuphold("WE","Twc",$realtobits(0.062),0,0,0,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 171;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on WE  --- \n\n", $time, test_num);
  setuphold("WE","Twc",$realtobits(0.062),0,1,0,2'b10,2'b01,2'b10);
  @(negedge CLK);
  @(negedge CLK);
  @(negedge CLK);
  $display ("\n#######################################################################");
  ...
  setuphold("WE_X","Twc",$realtobits(0.062),0,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  @(negedge CLK);
  write_mem(1,"","");
  ...
  setuphold("TEST1","TCT1X",$realtobits(1.661),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 182;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1  in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(1.661),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 183;
  ...
  setuphold("TEST1","TCT1X",$realtobits(1.661),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 186;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1  in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(1.661),1,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 187;
  ...
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.661),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 190;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST_RNM  in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.661),1,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 191;
  ...
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.661),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 194;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST_RNM  in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.661),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLK);
  ...
  setuphold("RM","Tcrm3x",$realtobits(1.661),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 202;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RM[3] Read mode  --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(1.661),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  RM = 4'b0011;
  ...
  setuphold("RM","Tcrm3x",$realtobits(1.661),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 210;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RM[3] in Write mode  --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(1.661),1,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  RM = 4'b0011;
  @(negedge CLK);
  $display ("\n#######################################################################");
  ...
  setuphold("WA","Tcwax",$realtobits(1.661),1,0,0,2'b10,2'b00,2'b00);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 222;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WA in Read Mode  --- \n\n", $time, test_num);
  setuphold("WA","Tcwax",$realtobits(1.661),1,1,0,2'b10,2'b00,2'b00);
   read_mem("",8'd0,32'b0);
  ...
  setuphold("WA","Tcwax",$realtobits(1.661),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 226;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WA in Write Mode  --- \n\n", $time, test_num);
  setuphold("WA","Tcwax",$realtobits(1.661),1,1,1,2'b10,2'b00,2'b11);
   read_mem("",8'd0,32'b0);
  ...
  setuphold("WPULSE","Tcwpx",$realtobits(1.661),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 230;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WPULSE in Write Mode  --- \n\n", $time, test_num);
  setuphold("WPULSE","Tcwpx",$realtobits(1.661),1,1,1,2'b10,2'b00,2'b11);
   read_mem("",8'd0,32'b0);
