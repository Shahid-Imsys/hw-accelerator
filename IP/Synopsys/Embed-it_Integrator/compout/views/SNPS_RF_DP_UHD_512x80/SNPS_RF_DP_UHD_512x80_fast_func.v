...
//  Date of Generation : Fri Dec 09 14:35:37 CET 2022                  
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
`endif
generic_behav_SNPS_RF_DP_UHD_512x80 #( MES_CNTRL, TCSEP) uut ( .QB(QB_mem), .ADRA(ADRA), .DA(DA), .WEA(WEA), .MEA(MEA), .CLKA(CLKA), .ADRB(ADRB), .MEB(MEB), .CLKB(CLKB) );
...
module generic_behav_SNPS_RF_DP_UHD_512x80 (  QB, ADRA, DA, WEA, MEA, CLKA, ADRB, MEB, CLKB );

parameter MES_CNTRL = "ON";
parameter TCSEP = 0.001;
parameter words = 256, bits = 80, addrbits = 8, wabits=2, wpulsebits=3;
