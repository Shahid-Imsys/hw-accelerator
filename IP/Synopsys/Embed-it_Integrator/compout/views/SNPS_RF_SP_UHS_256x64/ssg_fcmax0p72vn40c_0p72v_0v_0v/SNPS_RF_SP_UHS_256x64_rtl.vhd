...
entity generic_vhd_SNPS_RF_SP_UHS_256x64 is
  generic (
        words            : integer            := 256;
        addrbits         : integer            := 8;
        bits             : integer            := 64;
...
end generic_vhd_SNPS_RF_SP_UHS_256x64;

architecture behav of generic_vhd_SNPS_RF_SP_UHS_256x64 is
...
entity SNPS_RF_SP_UHS_256x64 is
...
end SNPS_RF_SP_UHS_256x64;

architecture behaviour of SNPS_RF_SP_UHS_256x64 is

component generic_vhd_SNPS_RF_SP_UHS_256x64
  generic (
        words             : integer                := 256;
        addrbits          : integer                := 8;
        bits              : integer                := 64;
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for u0 : generic_vhd_SNPS_RF_SP_UHS_256x64 use entity work.generic_vhd_SNPS_RF_SP_UHS_256x64(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  u0 : generic_vhd_SNPS_RF_SP_UHS_256x64
  generic map (
        NW                     => 256, 
        NADDR                  => 8,
        rmbits                 => 3,
...
configuration conf_SNPS_RF_SP_UHS_256x64_behaviour of SNPS_RF_SP_UHS_256x64 is
for behaviour
end for;
end conf_SNPS_RF_SP_UHS_256x64_behaviour;
