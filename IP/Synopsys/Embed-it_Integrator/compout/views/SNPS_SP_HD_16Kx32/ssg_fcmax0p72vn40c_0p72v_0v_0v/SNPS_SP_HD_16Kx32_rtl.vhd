...
entity generic_vhd_SNPS_SP_HD_16Kx32 is
  generic (
        words            : integer            := 16384;
        addrbits         : integer            := 14;
        bits             : integer            := 32;
...
end generic_vhd_SNPS_SP_HD_16Kx32;

architecture behav of generic_vhd_SNPS_SP_HD_16Kx32 is
...
process( CLK, D, BC0, BC1, BC2, TEST_RNM, TEST1, t3_me)
   ...
   VARIABLE Dlatched : std_logic_vector(31 downto 0);
...
procedure trash_mem(mem_core_array : inout ram_array) is
 variable word_line : std_logic_vector (31 downto 0);
 begin
...
end SNPS_SP_HD_16Kx32;

architecture behaviour of SNPS_SP_HD_16Kx32 is

component generic_vhd_SNPS_SP_HD_16Kx32
  generic (
        words             : integer                := 16384;
        addrbits          : integer                := 14;
        bits              : integer                := 32;
...
SIGNAL D_buf : STD_LOGIC_VECTOR(31 downto 0) := (others=>'0');
SIGNAL D_mout : STD_LOGIC_VECTOR(31 downto 0) := (others=>'0');
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_16Kx32 use entity work.generic_vhd_SNPS_SP_HD_16Kx32(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_16Kx32
  generic map (
        NW                     => 16384, 
        NADDR                  => 14,
        rmbits                 => 3,
...
configuration conf_SNPS_SP_HD_16Kx32_behaviour of SNPS_SP_HD_16Kx32 is
for behaviour
end for;
end conf_SNPS_SP_HD_16Kx32_behaviour;
