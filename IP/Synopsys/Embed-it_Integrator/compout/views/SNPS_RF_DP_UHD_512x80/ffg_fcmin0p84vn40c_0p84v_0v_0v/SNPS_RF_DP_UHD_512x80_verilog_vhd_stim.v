...
//  Date of Generation : Fri Dec 09 14:35:36 CET 2022                  
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
  ...
  WEA = 1'b0;
    ...
    begin 
      if ( paramr > 0.359 )
       ...
       #(0.359 - paramr + 0.001 + 0.001);
    end
    else
    begin
    if ( RMEB === 1'b0 )
      if ( paramr > 1.3449999999999998 )
       #0.001;
      else 
       #(1.3449999999999998 - paramr + 0.001 + 0.001);
    else
      begin
...
WPULSE = 3'b000;
 ...
 @(negedge CLKA);
  ...
  setupholdb("ADRB","Tac",$realtobits(0.088),0,0,0,2'b10,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 227;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ADRB in Read mode  --- \n\n", $time, test_num);
  setupholdb("ADRB","Tac",$realtobits(0.088),0,1,0,2'b10,2'b01,2'b01);
  @(negedge CLKB);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 228;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ADRB in Read mode  --- \n\n", $time, test_num);
  setupholdb("ADRB","Tcax",$realtobits(0.082),1,0,0,2'b10,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 229;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ADRB in Read mode  --- \n\n", $time, test_num);
  setupholdb("ADRB","Tcax",$realtobits(0.082),1,1,0,2'b10,2'b01,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 230;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tac",$realtobits(0.088),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 231;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tac",$realtobits(0.088),0,1,1,2'b01,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 232;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tcax",$realtobits(0.082),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 233;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tcax",$realtobits(0.082),1,1,1,2'b01,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 234;
  $display( "\n\n@%t TEST: %d --- Going to check Setup fall constraint on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tflsc",$realtobits(0.115),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 235;
  $display( "\n\n@%t TEST: %d --- Going to check Setup fall Violation on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tflsc",$realtobits(0.115),0,1,1,2'b01,2'b01,2'b11);
  $display ("\n#######################################################################");
  test_num = 236;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tlsx",$realtobits(0.060),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 237;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tlsx",$realtobits(0.060),1,1,1,2'b01,2'b01,2'b11);
  @(negedge CLKA);
  ...
  setupholdb("MEB","Tmc",$realtobits(0.051),0,0,0,2'b10,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 240;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on MEB in Read mode  --- \n\n", $time, test_num);
  setupholdb("MEB","Tmc",$realtobits(0.051),0,1,0,2'b10,2'b01,2'b01);
  @(negedge CLKB);
  write_mema(1,"","");
  $display ("\n#######################################################################");
  test_num = 241;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on MEB in Read mode  --- \n\n", $time, test_num);
  setupholdb("MEB","Tcmx",$realtobits(0.017),1,0,0,2'b10,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 242;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on MEB in Read mode  --- \n\n", $time, test_num);
  setupholdb("MEB","Tcmx",$realtobits(0.017),1,1,0,2'b10,2'b01,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 243;
  ...
  setupholda("MEA","Tmc",$realtobits(0.051),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 250;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on MEA in Write mode  --- \n\n", $time, test_num);
  setupholda("MEA","Tmc",$realtobits(0.051),0,1,1,2'b01,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 251;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on MEA in Write mode  --- \n\n", $time, test_num);
  setupholda("MEA","Tcmx",$realtobits(0.017),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 252;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on MEA in Write mode  --- \n\n", $time, test_num);
  setupholda("MEA","Tcmx",$realtobits(0.017),1,1,1,2'b01,2'b00,2'b11);
  @(negedge CLKA);
  @(negedge CLKA);
  LS = 1'b1;
  $display ("\n#######################################################################");
  ...
  setupholda("DA","Tcdx",$realtobits(0.100),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 258;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on DA in Write mode  --- \n\n", $time, test_num);
  setupholda("DA","Tcdx",$realtobits(0.100),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  ...
  setupholda("WEA","Twc",$realtobits(0.055),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 262;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on WEA  --- \n\n", $time, test_num);
  setupholda("WEA","Twc",$realtobits(0.055),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 263;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on WEA  with ADRA = X --- \n\n", $time, test_num);
  setupholda("WEA_ADRA_X","Twc",$realtobits(0.055),0,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 264;
  ...
  setupholda("WEA","Tcwx",$realtobits(0.017),1,0,0,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 268;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WEA  --- \n\n", $time, test_num);
  setupholda("WEA","Tcwx",$realtobits(0.017),1,1,0,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 269;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WEA  with ADRA = X --- \n\n", $time, test_num);
  setupholda("WEA_ADRA_X","Tcwx",$realtobits(0.017),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 270;
  ...
  setupholdb("TEST1B","TT1C",$realtobits(0.049),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 275;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST1B in Read mode  --- \n\n", $time, test_num);
  setupholdb("TEST1B","TT1C",$realtobits(0.049),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 276;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST1B in Read mode  --- \n\n", $time, test_num);
  setupholdb("TEST1B","TCT1X",$realtobits(1.009),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 277;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1B  in Read mode  --- \n\n", $time, test_num);
  setupholdb("TEST1B","TCT1X",$realtobits(1.009),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 278;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on TEST1A in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST1A","TT1C",$realtobits(0.049),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 279;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST1A in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST1A","TT1C",$realtobits(0.049),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 280;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST1A in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST1A","TCT1X",$realtobits(1.009),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 281;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1A  in Write mode  --- \n\n", $time, test_num);
setupholda("TEST1A","TCT1X",$realtobits(1.009),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  ...
  setupholdb("RMB","Trm3c",$realtobits(0.115),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 283;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMB[3] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Trm3c",$realtobits(0.115),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 284;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMB[1:0] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrmx",$realtobits(0.024),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 285;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMB[1:0] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrmx",$realtobits(0.024),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 286;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMB[3] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrm3x",$realtobits(1.009),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 287;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMB[3] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrm3x",$realtobits(1.009),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 288;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RMA[3] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Trm3c",$realtobits(0.115),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 289;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMA[3] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Trm3c",$realtobits(0.115),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 290;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMA[1:0] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrmx",$realtobits(0.024),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 291;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMA[1:0] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrmx",$realtobits(0.024),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 292;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMA[3] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrm3x",$realtobits(1.009),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 293;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMA[2] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrm3x",$realtobits(1.009),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  RMA = 4'b0011;
  RMB = 4'b0011;
  @(negedge CLKA);
  ...
  setupholdb("RMEB","Tcrmex",$realtobits(0.024),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 295;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMEB in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMEB","Tcrmex",$realtobits(0.024),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 296;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMEA in Write mode  --- \n\n", $time, test_num);
  setupholda("RMEA","Tcrmex",$realtobits(0.024),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 297;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMEA in Write mode  --- \n\n", $time, test_num);
  setupholda("RMEA","Tcrmex",$realtobits(0.024),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  RMA = 4'b0011;
  RMEA = 0;
  RMEB = 0;
  ...
  setupholda("TEST_RNMA","Ttrnmc",$realtobits(0.049),0,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 299;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST_RNMA in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST_RNMA","Ttrnmc",$realtobits(0.049),0,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 300;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST_RNMA in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST_RNMA","Tctrnmx",$realtobits(1.009),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 301;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST_RNMA  in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST_RNMA","Tctrnmx",$realtobits(1.009),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
...
WPULSE = 3'b000;
 ...
 @(negedge CLKB);
  ...
  setupholdb("LS","Tflsc",$realtobits(0.115),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 307;
  $display( "\n\n@%t TEST: %d --- Going to check Setup fall Violation on LS in Read mode  --- \n\n", $time, test_num);
  setupholdb("LS","Tflsc",$realtobits(0.115),0,1,0,2'b00,2'b01,2'b11);
  $display ("\n#######################################################################");
  test_num = 308;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on LS in Read mode  --- \n\n", $time, test_num);
  setupholdb("LS","Tlsx",$realtobits(0.060),1,0,0,2'b01,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 309;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS in Read mode  --- \n\n", $time, test_num);
  setupholdb("LS","Tlsx",$realtobits(0.060),1,1,0,2'b00,2'b01,2'b11);
  @(negedge CLKB);
  ...
  setupholda("WA","Tcwax",$realtobits(1.009),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
   $display ("\n#######################################################################");
  test_num = 312;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WA in Write Mode  --- \n\n", $time, test_num);
  setupholda("WA","Tcwax",$realtobits(1.009),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
   read_memb("",8'd0,80'b0);
  ...
  setupholda("WPULSE","Tcwpx",$realtobits(1.009),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
   $display ("\n#######################################################################");
  test_num = 314;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WPULSE in Write Mode  --- \n\n", $time, test_num);
  setupholda("WPULSE","Tcwpx",$realtobits(1.009),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
   read_memb("",8'd0,80'b0);
