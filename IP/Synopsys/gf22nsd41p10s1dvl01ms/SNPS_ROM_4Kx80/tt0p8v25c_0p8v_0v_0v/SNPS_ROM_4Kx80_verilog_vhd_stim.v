...
//  Date of Generation : Fri May 06 16:14:55 CEST 2022                 
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
reg [3:0] RM;
reg RME;
SNPS_ROM_4Kx80_behav  top_behav (  .Q( Q_BEHAV), .ADR( ADR), .ME( ME), .CLK( CLK), .LS( LS), .TEST1( TEST1), .RM( RM), .RME( RME) );
SNPS_ROM_4Kx80  top_struct (  .Q( Q), .ADR( ADR), .ME( ME), .CLK( CLK), .LS( LS), .TEST1( TEST1), .RM( RM), .RME( RME) );
...
//  #0;
  ...
  `endif
    //$vcdplusfile("SNPS_ROM_4Kx80.vpd");
    //$vcdpluson;
    //$dumpfile("SNPS_ROM_4Kx80.vcd");
    //$dumpvars();
  //$shm_open("waves.shm"); 
  //$shm_probe("AC"); 
    //$sdf_annotate( "SNPS_ROM_4Kx80.sdf");
end
