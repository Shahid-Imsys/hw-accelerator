...
//  Date of Generation : Mon Nov 14 13:57:53 CET 2022                  
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
SNPS_SP_HD_2Kx8_behav  top_behav (  .Q( Q_BEHAV), .ADR( ADR), .D( D), .WE( WE), .ME( ME), .CLK( CLK), .TEST1( TEST1), .TEST_RNM( TEST_RNM), .RME( RME), .RM( RM), .WA( WA), .WPULSE( WPULSE), .LS( LS), .BC0( BC0), .BC1( BC1), .BC2( BC2) );
SNPS_SP_HD_2Kx8  top_struct (  .Q( Q), .ADR( ADR), .D( D), .WE( WE), .ME( ME), .CLK( CLK), .TEST1( TEST1), .TEST_RNM( TEST_RNM), .RME( RME), .RM( RM), .WA( WA), .WPULSE( WPULSE), .LS( LS), .BC0( BC0), .BC1( BC1), .BC2( BC2) );
`define True    1'b1
`define False   1'b0
`define Mid     1'bx
`define Highz   1'bz
initial begin
  ...
  //$vcdpluson; 
    ...
    //$sdf_annotate( "SNPS_SP_HD_2Kx8.sdf");
end
task print_tdcs;
input count;
...
task compare_Q;
  ...
  input [7:0] Q_BEHAV;
    ...
    if ( Q === 8'bz && Q_BEHAV === 8'bz )
      OP_Q = 8'b0;
    else if ( Q === 8'bx && Q_BEHAV === 8'bx  )
      OP_Q = 8'b0;
    else begin
...
input [7:0] data; //if null,data=0 in case of single location,else data=addr.
integer k;
integer j;
integer l;
reg [7:0]  i;
...
begin
  ...
  begin
    ...
    if (signal == "TEST1" && oper1 == 0 )
      TEST1 <= #1.5839999999999999 1'b1;
    else if ( signal == "TEST1" )
      TEST1 <= #1.5839999999999999 1'b0;
  if (signal == "TEST_RNM")
    TEST_RNM = 1'b1;
  if (signal == "RM" )
  begin
...
begin
 ...
 if (signal == "ME_X")
  ...
  begin
    ...
    begin
      if (Q_BEHAV === 8'b11111111) stat = 0;
      else stat = 1;
    end
    else if ( outstat == 2'b11 )
    begin
      if (Q_BEHAV === 8'd0) stat = 0;
      else stat = 1;
    end
    if (stat == 0)
    begin
  ...
  begin
    ...
    begin
      if ( chk == 2'b11 )
      begin
        read_mem("",11'd2047,8'bx);
        write_mem("",11'd2047,8'b0);
      end
      else
      begin
        read_mem("",11'd0,8'bx);
        write_mem("",11'd0,8'b0);
      end
    end
...
task coverage_1;
 ...
 @(posedge CLK) begin
     ...
     D[7:0] = pattern_reg[18:11];
     WE = pattern_reg[19];
     ME = pattern_reg[20];
     TEST1 = pattern_reg[21];
     TEST_RNM = pattern_reg[22];
     RME = pattern_reg[23];
     RM[3:0] = pattern_reg[27:24];
     WA[1:0] = pattern_reg[29:28];
     WPULSE[2:0] = pattern_reg[32:30];
     LS = pattern_reg[33];
     BC0 = pattern_reg[34];
     BC1 = pattern_reg[35];
     BC2 = pattern_reg[36];
...
begin
 ...
 $display("@%t  ============= When BC0 = %d ================ ", $time, bc0_i);
  ...
  write_mem("",11'b0,8'd0);
  @(negedge CLK);
  ADR = 1;
  $display("@%t    Writing 8'b11111111 at %b", $time,ADR);
  write_mem("",11'b1,8'b11111111);
...
WPULSE = 3'b000;
  ...
  @(negedge CLK);
  ADR = 1;
  $display("@%t    Reading 8'b11111111 at %b", $time,ADR);
  read_mem("",11'b1, 8'b11111111);
...
WPULSE = 3'b000;
 ...
 $display("Non recommended warning messages may come in simulation log file.");
  ...
  @(negedge CLK);
  ADR = 2;
  $display("@%t    Writing 8'b10101010 at %b", $time,ADR);
  write_mem("",2,8'b10101010);
  @(negedge CLK);
  ADR = 3;
  $display("@%t    Writing 8'b01010101 at %b", $time,ADR);
  write_mem("",3,8'b01010101);
  @(negedge CLK);
  ADR = 0;
  $display("@%t    Reading 0 at %b", $time,ADR);
  read_mem("",11'b0, 8'd0);
  ...
  @(negedge CLK);
  ADR = 2;
  $display("@%t    Reading 8'b10101010 at %b", $time,ADR);
  read_mem("",2,8'b10101010);
  @(negedge CLK);
  ADR = 3;
  $display("@%t    Reading 8'b01010101 at %b", $time,ADR);
  read_mem("",3,8'b01010101);
  ...
  WE = 1'b1;
  @(negedge CLK);
  $display("@%t    Writing in Memory data = 8'b10101010 during TEST1 active", $time);
   write_mem(1,11'bx,8'b10101010); 
  @(negedge CLK);
  @(negedge CLK);
   read_mem_test1(1,11'bx,8'b10101010); 
  if (err_cnt == 0)
  begin
...
`endif
  ...
  begin
    ...
    begin
     ...
     $display ("\n@%t            FAIL\n", $time);
      $display ("ERROR_MODEL: Mismatch observed at ADR %d, simulated value = %h, expected value = 8'bx at time %t  ",ADR, Q_BEHAV, $time);
    end
    else 
    begin
...
`endif
 ...
 $display("@%t  ============= When BC0 = %d ================ ", $time, bc0_i);
  ...
  ADR[0] = 1;
  $display("@%t    Writing 8'b11111111 at %b", $time,ADR);
  write_mem("",ADR, 8'b11111111);
  @(negedge CLK);
  ADR[10] = 1;
  $display("@%t    Writing 8'b10101010 at %b", $time,ADR);
  write_mem("",ADR, 8'b10101010);
  @(negedge CLK);
  ADR[0] = 0;
  $display("@%t    Writing 8'b01010101 at %b", $time,ADR);
  write_mem("",ADR, 8'b01010101);
  @(negedge CLK);
  ADR = 0;
  WE = 1'b0;
  $display("@%t    Reading 0 at %b", $time,ADR);
...
WPULSE = 3'b000;
  ...
  setuphold("ADR","Tac",$realtobits(0.072),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 111;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ADR in Read mode  --- \n\n", $time, test_num);
  setuphold("ADR","Tac",$realtobits(0.072),0,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 112;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ADR in Read mode  --- \n\n", $time, test_num);
  setuphold("ADR","Tcax",$realtobits(0.095),1,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 113;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ADR in Read mode  --- \n\n", $time, test_num);
  setuphold("ADR","Tcax",$realtobits(0.095),1,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 114;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on ADR in Write mode  --- \n\n", $time, test_num);
  setuphold("ADR","Tac",$realtobits(0.072),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 115;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ADR in Write mode  --- \n\n", $time, test_num);
  setuphold("ADR","Tac",$realtobits(0.072),0,1,1,2'b10,2'b00,2'b11);
  @(negedge CLK);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 116;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ADR in Write mode  --- \n\n", $time, test_num);
  setuphold("ADR","Tcax",$realtobits(0.095),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 117;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ADR in Write mode  --- \n\n", $time, test_num);
  setuphold("ADR","Tcax",$realtobits(0.095),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLK);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 118;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on LS when BC0 = 0 in Write mode  --- \n\n", $time, test_num);
  setuphold("LS","Tfls0c",$realtobits(1.060),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 119;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on LS when BC0 = 0 in Write mode  --- \n\n", $time, test_num);
  setuphold("LS","Tfls0c",$realtobits(1.060),0,1,1,2'b10,2'b01,2'b11);
  $display ("\n#######################################################################");
  test_num = 120;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on LS when BC0 = 0 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS","Tfls0c",$realtobits(1.060),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 121;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on LS when BC0 = 0 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS","Tfls0c",$realtobits(1.060),0,1,0,2'b10,2'b01,2'b11);
  ...
  setuphold("LS","Tlsx",$realtobits(0.109),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 127;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS when BC0 = 0 in Write mode  --- \n\n", $time, test_num);
  setuphold("LS","Tlsx",$realtobits(0.109),1,1,1,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 128;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on LS when BC0 = 0 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS","Tlsx",$realtobits(0.109),1,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 129;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS when BC0 = 0 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS","Tlsx",$realtobits(0.109),1,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 130;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on LS when BC0 = 1 in Write mode  --- \n\n", $time, test_num);
  setuphold("LS_BC0_1","Tlsx",$realtobits(0.109),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 131;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS when BC0 = 1 in Write mode  --- \n\n", $time, test_num);
  setuphold("LS_BC0_1","Tlsx",$realtobits(0.109),1,1,1,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 132;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on LS when BC0 = 1 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS_BC0_1","Tlsx",$realtobits(0.109),1,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 133;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS when BC0 = 1 in Read mode  --- \n\n", $time, test_num);
  setuphold("LS_BC0_1","Tlsx",$realtobits(0.109),1,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 158;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[0 : 0](Td1c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 0; d_num <= 0; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 159;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[1 : 1](Td2c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 1; d_num <= 1; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 160;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[2 : 2](Td3c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 2; d_num <= 2; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 161;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[3 : 3](Td4c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 3; d_num <= 3; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 162;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[4 : 4](Td5c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 4; d_num <= 4; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 163;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[5 : 5](Td6c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 5; d_num <= 5; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 164;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[6 : 6](Td7c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 6; d_num <= 6; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 165;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Constraint on D[7 : 7](Td8c_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 7; d_num <= 7; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 166;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[0 : 0](Td1c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 0; d_num <= 0; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 167;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[1 : 1](Td2c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 1; d_num <= 1; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 168;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[2 : 2](Td3c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 2; d_num <= 2; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 169;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[3 : 3](Td4c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 3; d_num <= 3; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 170;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[4 : 4](Td5c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 4; d_num <= 4; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 171;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[5 : 5](Td6c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 5; d_num <= 5; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 172;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[6 : 6](Td7c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 6; d_num <= 6; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 173;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[7 : 7](Td8c_h) in Write mode  --- \n\n", $time, test_num);
     write_mem("",11'd0, 8'd0);
  for ( d_num = 7; d_num <= 7; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 174;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[0 : 0](Tcd1x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 0; d_num <= 0; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 175;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[1 : 1](Tcd2x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 1; d_num <= 1; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 176;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[2 : 2](Tcd3x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 2; d_num <= 2; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 177;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[3 : 3](Tcd4x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 3; d_num <= 3; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 178;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[4 : 4](Tcd5x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 4; d_num <= 4; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 179;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[5 : 5](Tcd6x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 5; d_num <= 5; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 180;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[6 : 6](Tcd7x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 6; d_num <= 6; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 181;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Constraint on D[7 : 7](Tcd8x_h) in Write mode  --- \n\n", $time, test_num);
  for ( d_num = 7; d_num <= 7; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
     write_mem("",11'd0, 8'd0);
  ...
  $display ("\n#######################################################################");
  test_num = 182;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[0 : 0](Tcd1x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 0; d_num <= 0; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 183;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[1 : 1](Tcd2x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 1; d_num <= 1; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 184;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[2 : 2](Tcd3x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 2; d_num <= 2; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 185;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[3 : 3](Tcd4x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 3; d_num <= 3; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 186;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[4 : 4](Tcd5x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 4; d_num <= 4; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 187;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[5 : 5](Tcd6x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 5; d_num <= 5; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 188;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[6 : 6](Tcd7x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 6; d_num <= 6; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 189;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[7 : 7](Tcd8x_h) in Write mode  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'd0);
  for ( d_num = 7; d_num <= 7; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 190;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[0 : 0](Td1c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 0; d_num <= 0; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
    $display ("\n@%t  Check Setup Violation with D[%0d] bit", $time, d_num);
  ...
  $display ("\n#######################################################################");
  test_num = 191;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[1 : 1](Td2c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 1; d_num <= 1; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 192;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[2 : 2](Td3c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 2; d_num <= 2; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 193;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[3 : 3](Td4c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 3; d_num <= 3; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 194;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[4 : 4](Td5c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 4; d_num <= 4; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 195;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[5 : 5](Td6c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 5; d_num <= 5; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 196;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[6 : 6](Td7c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 6; d_num <= 6; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 197;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Setup Violation on D[7 : 7](Td8c_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 7; d_num <= 7; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 198;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[0 : 0](Tcd1x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 0; d_num <= 0; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 199;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[1 : 1](Tcd2x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 1; d_num <= 1; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 200;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[2 : 2](Tcd3x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 2; d_num <= 2; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 201;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[3 : 3](Tcd4x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 3; d_num <= 3; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 202;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[4 : 4](Tcd5x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 4; d_num <= 4; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 203;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[5 : 5](Tcd6x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 5; d_num <= 5; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 204;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[6 : 6](Tcd7x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 6; d_num <= 6; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  $display ("\n#######################################################################");
  test_num = 205;
  $display( "\n\n@%t TEST: %d --- Going to check Bitwise Hold Violation on D[7 : 7](Tcd8x_h) in Write mode with output bits high  --- \n\n", $time, test_num);
  write_mem("",11'd0, 8'b11111111);
  for ( d_num = 7; d_num <= 7; d_num = d_num + 1 ) 
  begin
    @(negedge CLK);
  ...
  setuphold("WE","Tcwx",$realtobits(0.093),1,0,0,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 212;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WE  --- \n\n", $time, test_num);
  setuphold("WE","Tcwx",$realtobits(0.093),1,1,0,2'b10,2'b01,2'b10);
  @(negedge CLK);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 213;
  ...
  setuphold("TEST1","TT1C",$realtobits(0.063),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 218;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST1 in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TT1C",$realtobits(0.063),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 219;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST1 in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(1.583),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 220;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1  in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(1.583),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 221;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on TEST1 in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TT1C",$realtobits(0.063),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 222;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST1 in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TT1C",$realtobits(0.063),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 223;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST1 in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(1.583),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 224;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1  in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST1","TCT1X",$realtobits(1.583),1,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 225;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on TEST_RNM in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Ttrnmc",$realtobits(0.063),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 226;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST_RNM in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Ttrnmc",$realtobits(0.063),0,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 227;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST_RNM in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.583),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 228;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST_RNM  in Read mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.583),1,1,0,2'b10,2'b01,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 229;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on TEST_RNM in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Ttrnmc",$realtobits(0.063),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 230;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST_RNM in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Ttrnmc",$realtobits(0.063),0,1,1,2'b01,2'b00,2'b11);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 231;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST_RNM in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.583),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 232;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST_RNM  in Write mode  --- \n\n", $time, test_num);
  setuphold("TEST_RNM","Tctrnmx",$realtobits(1.583),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLK);
  ...
  setuphold("RM","Trmc",$realtobits(0.210),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 234;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RM[2:0] in Read mode  --- \n\n", $time, test_num);
  setuphold("RM","Trmc",$realtobits(0.210),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 235;
  ...
  setuphold("RM","Trm3c",$realtobits(1.060),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 238;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RM[3] in Read mode  --- \n\n", $time, test_num);
  setuphold("RM","Trm3c",$realtobits(1.060),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 239;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RM[3] Read mode  --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(1.583),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 240;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RM[3] Read mode  --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(1.583),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  RM = 4'b0011;
  ...
  setuphold("RM","Trmc",$realtobits(0.210),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 242;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RM[2:0] in Write mode  --- \n\n", $time, test_num);
  setuphold("RM","Trmc",$realtobits(0.210),0,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 243;
  ...
  setuphold("RM","Trm3c",$realtobits(1.060),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 246;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RM[3] in Write mode  --- \n\n", $time, test_num);
  setuphold("RM","Trm3c",$realtobits(1.060),0,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 247;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RM[3] in Write mode  --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(1.583),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 248;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RM[3] in Write mode  --- \n\n", $time, test_num);
  setuphold("RM","Tcrm3x",$realtobits(1.583),1,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  RM = 4'b0011;
  @(negedge CLK);
  $display ("\n#######################################################################");
  ...
  setuphold("RME","Trmec",$realtobits(0.210),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLK);
    RME = 1'b1;
  $display ("\n#######################################################################");
  test_num = 250;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RME in Read mode  --- \n\n", $time, test_num);
  setuphold("RME","Trmec",$realtobits(0.210),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 251;
  ...
  setuphold("RME","Trmec",$realtobits(0.210),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLK);
    RME = 1'b1;
  $display ("\n#######################################################################");
  test_num = 254;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RME in Write mode  --- \n\n", $time, test_num);
  setuphold("RME","Trmec",$realtobits(0.210),0,1,1,2'b10,2'b00,2'b10);
  @(negedge CLK);
  $display ("\n#######################################################################");
  test_num = 255;
  ...
  setuphold("WA","Tcwax",$realtobits(1.583),1,0,0,2'b10,2'b00,2'b00);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 258;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WA in Read Mode  --- \n\n", $time, test_num);
  setuphold("WA","Tcwax",$realtobits(1.583),1,1,0,2'b10,2'b00,2'b00);
   read_mem("",11'd0,8'b0);
  ...
  setuphold("WA","Tcwax",$realtobits(1.583),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 260;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WA in Write Mode  --- \n\n", $time, test_num);
  setuphold("WA","Tcwax",$realtobits(1.583),1,1,1,2'b10,2'b00,2'b11);
   read_mem("",11'd0,8'b0);
  ...
  setuphold("WPULSE","Tcwpx",$realtobits(1.583),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 262;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WPULSE in Write Mode  --- \n\n", $time, test_num);
  setuphold("WPULSE","Tcwpx",$realtobits(1.583),1,1,1,2'b10,2'b00,2'b11);
   read_mem("",11'd0,8'b0);
  ...
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on BC0 in Light Sleep Mode  --- \n\n", $time, test_num);
   setuphold("BC0","Tbc0c",$realtobits(1.060),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 264;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on BC0 in Light Sleep Mode  --- \n\n", $time, test_num);
   setuphold("BC0","Tbc0c",$realtobits(1.060),0,1,0,2'b01,2'b00,2'b11);
   read_mem("",11'd0,8'b0);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 265;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on BC1 in Light Sleep Mode  --- \n\n", $time, test_num);
   setuphold("BC1","Tbc1c",$realtobits(0.205),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 266;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on BC1 in Light Sleep Mode  --- \n\n", $time, test_num);
   setuphold("BC1","Tbc1c",$realtobits(0.205),0,1,0,2'b01,2'b00,2'b11);
   read_mem("",11'd0,8'b0);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 267;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on BC2 in Light Sleep Mode  --- \n\n", $time, test_num);
   setuphold("BC2","Tbc2c",$realtobits(0.205),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLK);
   $display ("\n#######################################################################");
  test_num = 268;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on BC2 in Light Sleep Mode  --- \n\n", $time, test_num);
   setuphold("BC2","Tbc2c",$realtobits(0.205),0,1,0,2'b01,2'b00,2'b11);
   read_mem("",11'd0,8'b0);
  write_mem(1,"","");
  read_mem(1,"","");
`ifdef code_coverage
