...
entity generic_vhd_SNPS_SP_HD_512x8 is
  generic (
        words            : integer            := 512;
        addrbits         : integer            := 9;
        bits             : integer            := 8;
...
end generic_vhd_SNPS_SP_HD_512x8;

architecture behav of generic_vhd_SNPS_SP_HD_512x8 is
...
end SNPS_SP_HD_512x8;

architecture behaviour of SNPS_SP_HD_512x8 is

component generic_vhd_SNPS_SP_HD_512x8
  generic (
        words             : integer                := 512;
        addrbits          : integer                := 9;
        bits              : integer                := 8;
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_512x8 use entity work.generic_vhd_SNPS_SP_HD_512x8(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_512x8
  generic map (
        NW                     => 512, 
        NADDR                  => 9,
        rmbits                 => 3,
...
configuration conf_SNPS_SP_HD_512x8_behaviour of SNPS_SP_HD_512x8 is
for behaviour
end for;
end conf_SNPS_SP_HD_512x8_behaviour;
