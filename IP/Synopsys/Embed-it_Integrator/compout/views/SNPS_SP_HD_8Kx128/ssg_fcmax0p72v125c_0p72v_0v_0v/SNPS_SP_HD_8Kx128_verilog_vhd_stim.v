...
begin
     ...
     if ( count >= 0 && count <= 7 )
     begin
       delay = (time_low + 0.261 - 0.001);
     end
     if ( count >= 8 && count <= 15 )
     begin
       delay = (time_low + 0.259 - 0.001);
     end
     if ( count >= 16 && count <= 23 )
     begin
       delay = (time_low + 0.253 - 0.001);
     end
     if ( count >= 24 && count <= 31 )
     begin
       delay = (time_low + 0.242 - 0.001);
     end
     if ( count >= 32 && count <= 39 )
     begin
       delay = (time_low + 0.171 - 0.001);
     end
     if ( count >= 40 && count <= 47 )
     begin
