...
//  Date of Generation : Fri Dec 09 16:07:52 CET 2022                  
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
integer temp_addr;
SNPS_RF_DP_HD_256x80_behav  top_behav (  .QB( QB_BEHAV), .ADRA( ADRA), .DA( DA), .WEA( WEA), .MEA( MEA), .CLKA( CLKA), .TEST1A( TEST1A), .TEST_RNMA( TEST_RNMA), .RMEA( RMEA), .RMA( RMA), .WA( WA), .WPULSE( WPULSE), .LS( LS), .ADRB( ADRB), .MEB( MEB), .CLKB( CLKB), .TEST1B( TEST1B), .RMEB( RMEB), .RMB( RMB) );
SNPS_RF_DP_HD_256x80  top_struct (  .QB( QB), .ADRA( ADRA), .DA( DA), .WEA( WEA), .MEA( MEA), .CLKA( CLKA), .TEST1A( TEST1A), .TEST_RNMA( TEST_RNMA), .RMEA( RMEA), .RMA( RMA), .WA( WA), .WPULSE( WPULSE), .LS( LS), .ADRB( ADRB), .MEB( MEB), .CLKB( CLKB), .TEST1B( TEST1B), .RMEB( RMEB), .RMB( RMB) );
`define True    1'b1
`define False   1'b0
`define Mid     1'bx
`define Highz   1'bz
initial begin
  ...
  `endif 
    //$vcdplusfile("SNPS_RF_DP_HD_256x80.vpd");
    //$vcdpluson;
    //$dumpfile("SNPS_RF_DP_HD_256x80.vcd");
    //$dumpvars();
    //$shm_open("waves.shm"); 
    //$shm_probe("AC"); 
    //$sdf_annotate( "SNPS_RF_DP_HD_256x80.sdf");
end
