...
//  Date of Generation : Mon May 23 15:53:56 CEST 2022                 
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
WPULSE = 3'b000;
 ...
 @(negedge CLKA);
  ...
  setupholdb("ADRB","Tac",$realtobits(0.112),0,0,0,2'b10,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 227;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ADRB in Read mode  --- \n\n", $time, test_num);
  setupholdb("ADRB","Tac",$realtobits(0.112),0,1,0,2'b10,2'b01,2'b01);
  @(negedge CLKB);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 228;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ADRB in Read mode  --- \n\n", $time, test_num);
  setupholdb("ADRB","Tcax",$realtobits(0.181),1,0,0,2'b10,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 229;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ADRB in Read mode  --- \n\n", $time, test_num);
  setupholdb("ADRB","Tcax",$realtobits(0.181),1,1,0,2'b10,2'b01,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 230;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tac",$realtobits(0.112),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 231;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tac",$realtobits(0.112),0,1,1,2'b01,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 232;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tcax",$realtobits(0.181),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 233;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on ADRA in Write mode  --- \n\n", $time, test_num);
  setupholda("ADRA","Tcax",$realtobits(0.181),1,1,1,2'b01,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 234;
  $display( "\n\n@%t TEST: %d --- Going to check Setup fall constraint on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tflsc",$realtobits(0.880),0,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 235;
  $display( "\n\n@%t TEST: %d --- Going to check Setup fall Violation on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tflsc",$realtobits(0.880),0,1,1,2'b01,2'b01,2'b11);
  $display ("\n#######################################################################");
  test_num = 236;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tlsx",$realtobits(0.147),1,0,1,2'b01,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 237;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS in Write mode  --- \n\n", $time, test_num);
  setupholda("LS","Tlsx",$realtobits(0.147),1,1,1,2'b01,2'b01,2'b11);
  @(negedge CLKA);
  ...
  setupholda("DA","Tdc",$realtobits(0.002),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 258;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on DA in Write mode  --- \n\n", $time, test_num);
  setupholda("DA","Tdc",$realtobits(0.002),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 259;
  ...
  setupholda("WEA","Twc",$realtobits(0.116),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 267;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on WEA  --- \n\n", $time, test_num);
  setupholda("WEA","Twc",$realtobits(0.116),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 268;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on WEA  with ADRA = X --- \n\n", $time, test_num);
  setupholda("WEA_ADRA_X","Twc",$realtobits(0.116),0,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 269;
  ...
  setupholdb("TEST1B","TT1C",$realtobits(0.152),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 280;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST1B in Read mode  --- \n\n", $time, test_num);
  setupholdb("TEST1B","TT1C",$realtobits(0.152),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 281;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST1B in Read mode  --- \n\n", $time, test_num);
  setupholdb("TEST1B","TCT1X",$realtobits(3.216),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 282;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1B  in Read mode  --- \n\n", $time, test_num);
  setupholdb("TEST1B","TCT1X",$realtobits(3.216),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 283;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on TEST1A in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST1A","TT1C",$realtobits(0.152),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 284;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST1A in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST1A","TT1C",$realtobits(0.152),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 285;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST1A in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST1A","TCT1X",$realtobits(3.216),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 286;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST1A  in Write mode  --- \n\n", $time, test_num);
setupholda("TEST1A","TCT1X",$realtobits(3.216),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  ...
  setupholdb("RMB","Trmc",$realtobits(0.131),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 288;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMB[2:0] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Trmc",$realtobits(0.131),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 289;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RMB[3] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Trm3c",$realtobits(0.880),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 290;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMB[3] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Trm3c",$realtobits(0.880),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 291;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMB[1:0] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrmx",$realtobits(0.049),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 292;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMB[1:0] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrmx",$realtobits(0.049),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 293;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMB[3] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrm3x",$realtobits(3.216),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 294;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMB[3] in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMB","Tcrm3x",$realtobits(3.216),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 295;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RMA[2:0] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Trmc",$realtobits(0.131),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 296;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMA[2:0] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Trmc",$realtobits(0.131),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 297;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RMA[3] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Trm3c",$realtobits(0.880),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 298;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMA[3] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Trm3c",$realtobits(0.880),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 299;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMA[1:0] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrmx",$realtobits(0.049),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 300;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMA[1:0] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrmx",$realtobits(0.049),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 301;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMA[3] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrm3x",$realtobits(3.216),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 302;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMA[2] in Write mode  --- \n\n", $time, test_num);
  setupholda("RMA","Tcrm3x",$realtobits(3.216),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  RMA = 4'b0011;
  RMB = 4'b0011;
  @(negedge CLKA);
  ...
  setupholdb("RMEB","Trmec",$realtobits(0.131),0,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 304;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMEB in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMEB","Trmec",$realtobits(0.131),0,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 305;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMEB in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMEB","Tcrmex",$realtobits(0.049),1,0,0,2'b00,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 306;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMEB in Read mode  --- \n\n", $time, test_num);
  setupholdb("RMEB","Tcrmex",$realtobits(0.049),1,1,0,2'b10,2'b01,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 307;
  $display( "\n\n@%t TEST: %d --- Going to check Setup constraint on RMEA in Write mode  --- \n\n", $time, test_num);
  setupholda("RMEA","Trmec",$realtobits(0.131),0,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 308;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on RMEA in Write mode  --- \n\n", $time, test_num);
  setupholda("RMEA","Trmec",$realtobits(0.131),0,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 309;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on RMEA in Write mode  --- \n\n", $time, test_num);
  setupholda("RMEA","Tcrmex",$realtobits(0.049),1,0,1,2'b01,2'b00,2'b00);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 310;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on RMEA in Write mode  --- \n\n", $time, test_num);
  setupholda("RMEA","Tcrmex",$realtobits(0.049),1,1,1,2'b01,2'b00,2'b10);
  @(negedge CLKA);
  RMA = 4'b0011;
  RMEA = 0;
  RMEB = 0;
  ...
  setupholda("TEST_RNMA","Ttrnmc",$realtobits(0.152),0,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 312;
  $display( "\n\n@%t TEST: %d --- Going to check Setup Violation on TEST_RNMA in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST_RNMA","Ttrnmc",$realtobits(0.152),0,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 313;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on TEST_RNMA in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST_RNMA","Tctrnmx",$realtobits(3.216),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
  $display ("\n#######################################################################");
  test_num = 314;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on TEST_RNMA  in Write mode  --- \n\n", $time, test_num);
  setupholda("TEST_RNMA","Tctrnmx",$realtobits(3.216),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
...
WPULSE = 3'b000;
 ...
 @(negedge CLKB);
  ...
  setupholdb("LS","Tflsc",$realtobits(0.880),0,0,0,2'b01,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 320;
  $display( "\n\n@%t TEST: %d --- Going to check Setup fall Violation on LS in Read mode  --- \n\n", $time, test_num);
  setupholdb("LS","Tflsc",$realtobits(0.880),0,1,0,2'b00,2'b01,2'b11);
  $display ("\n#######################################################################");
  test_num = 321;
  $display( "\n\n@%t TEST: %d --- Going to check Hold constraint on LS in Read mode  --- \n\n", $time, test_num);
  setupholdb("LS","Tlsx",$realtobits(0.147),1,0,0,2'b01,2'b00,2'b01);
  @(negedge CLKB);
  $display ("\n#######################################################################");
  test_num = 322;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on LS in Read mode  --- \n\n", $time, test_num);
  setupholdb("LS","Tlsx",$realtobits(0.147),1,1,0,2'b00,2'b01,2'b11);
  @(negedge CLKB);
  ...
  setupholda("WA","Tcwax",$realtobits(3.216),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
   $display ("\n#######################################################################");
  test_num = 325;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WA in Write Mode  --- \n\n", $time, test_num);
  setupholda("WA","Tcwax",$realtobits(3.216),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
   read_memb("",10'd0,80'b0);
  ...
  setupholda("WPULSE","Tcwpx",$realtobits(3.216),1,0,1,2'b10,2'b00,2'b01);
  @(negedge CLKA);
   $display ("\n#######################################################################");
  test_num = 327;
  $display( "\n\n@%t TEST: %d --- Going to check Hold Violation on WPULSE in Write Mode  --- \n\n", $time, test_num);
  setupholda("WPULSE","Tcwpx",$realtobits(3.216),1,1,1,2'b10,2'b00,2'b11);
  @(negedge CLKA);
   read_memb("",10'd0,80'b0);
