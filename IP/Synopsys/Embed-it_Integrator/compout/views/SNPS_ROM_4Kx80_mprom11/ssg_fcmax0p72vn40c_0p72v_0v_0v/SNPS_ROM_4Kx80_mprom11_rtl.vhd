...
entity generic_vhd_SNPS_ROM_4Kx80_mprom11 is
  generic (
        PreloadFilename   : string               := "SNPS_ROM_4Kx80_mprom11.hex";
...
end generic_vhd_SNPS_ROM_4Kx80_mprom11;

architecture behav of generic_vhd_SNPS_ROM_4Kx80_mprom11 is
...
entity SNPS_ROM_4Kx80_mprom11 is
...
end SNPS_ROM_4Kx80_mprom11;

architecture behaviour of SNPS_ROM_4Kx80_mprom11 is

SIGNAL ADR_buf : STD_LOGIC_VECTOR(11 downto 0);
SIGNAL ME_buf : STD_LOGIC;
SIGNAL t3_me  : time := 0 ns;

component generic_vhd_SNPS_ROM_4Kx80_mprom11
  generic (  
        PreloadFilename   : string                 := "SNPS_ROM_4Kx80_mprom11.hex"; 
        words             : integer                := 4096;
        addrbits          : integer                := 12;
...
SIGNAL disp_LS_msg :STD_LOGIC :='1';
  ...
  for uut : generic_vhd_SNPS_ROM_4Kx80_mprom11 use entity work.generic_vhd_SNPS_ROM_4Kx80_mprom11(behav);
  BEGIN
  ...
  uut : generic_vhd_SNPS_ROM_4Kx80_mprom11
  generic map (
...
configuration conf_SNPS_ROM_4Kx80_mprom11_behaviour of SNPS_ROM_4Kx80_mprom11 is
for behaviour
end for;
end conf_SNPS_ROM_4Kx80_mprom11_behaviour;
