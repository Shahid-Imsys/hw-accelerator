...
entity generic_vhd_SNPS_ROM_4Kx80 is
  generic (
        PreloadFilename   : string               := "SNPS_ROM_4Kx80.hex";
...
end generic_vhd_SNPS_ROM_4Kx80;

architecture behav of generic_vhd_SNPS_ROM_4Kx80 is
...
SIGNAL disp_LS_msg :STD_LOGIC :='1';
  ...
  for uut : generic_vhd_SNPS_ROM_4Kx80 use entity work.generic_vhd_SNPS_ROM_4Kx80(behav);
  BEGIN
  ...
  uut : generic_vhd_SNPS_ROM_4Kx80
  generic map (
...
configuration conf_SNPS_ROM_4Kx80_behaviour of SNPS_ROM_4Kx80 is
for behaviour
end for;
end conf_SNPS_ROM_4Kx80_behaviour;
