...
entity generic_vhd_SNPS_SP_HD_2Kx8 is
  generic (
        words            : integer            := 2048;
        addrbits         : integer            := 11;
        bits             : integer            := 8;
...
end generic_vhd_SNPS_SP_HD_2Kx8;

architecture behav of generic_vhd_SNPS_SP_HD_2Kx8 is
...
architecture behaviour of SNPS_SP_HD_2Kx8 is

component generic_vhd_SNPS_SP_HD_2Kx8
  generic (
        words             : integer                := 2048;
        addrbits          : integer                := 11;
        bits              : integer                := 8;
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_2Kx8 use entity work.generic_vhd_SNPS_SP_HD_2Kx8(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_2Kx8
  generic map (
        NW                     => 2048, 
        NADDR                  => 11,
        rmbits                 => 3,
...
configuration conf_SNPS_SP_HD_2Kx8_behaviour of SNPS_SP_HD_2Kx8 is
for behaviour
end for;
end conf_SNPS_SP_HD_2Kx8_behaviour;
