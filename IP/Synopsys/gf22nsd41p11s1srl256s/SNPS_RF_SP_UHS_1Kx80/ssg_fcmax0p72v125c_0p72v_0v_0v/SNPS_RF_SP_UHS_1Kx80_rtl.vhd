...
--  Date of Generation : Fri May 06 10:36:10 CEST 2022                 
--                                                                     
-----------------------------------------------------------------------
--   --------------------------------------------------------------     
...
entity generic_vhd_SNPS_RF_SP_UHS_1Kx80 is
  generic (
        words             : integer                := 1024;
        addrbits          : integer                := 10;
        bits              : integer                := 80;
...
end generic_vhd_SNPS_RF_SP_UHS_1Kx80;

architecture behav of generic_vhd_SNPS_RF_SP_UHS_1Kx80 is
...
SIGNAL  ADRA_old : std_logic_vector(9 downto 0);
...
SIGNAL  ADRB_old : std_logic_vector(9 downto 0);
...
process( CLKA ,DA , TEST1A ,CLKB , TEST1B ,TEST_RNMA, t3a_me, t3b_me)
   ...
   VARIABLE ADRAlatched : std_logic_vector(9 downto 0);
   ...
   VARIABLE ADRBlatched : std_logic_vector(9 downto 0);
...
entity SNPS_RF_SP_UHS_1Kx80 is
...
end SNPS_RF_SP_UHS_1Kx80;

architecture behaviour of SNPS_RF_SP_UHS_1Kx80 is

component generic_vhd_SNPS_RF_SP_UHS_1Kx80
  generic (
        words             : integer                := 1024;
        addrbits          : integer                := 10;
        bits              : integer                := 80;
...
SIGNAL ADRA_buf : STD_LOGIC_VECTOR(9 downto 0) := (others=>'0');
SIGNAL ADRA_mout : STD_LOGIC_VECTOR(9 downto 0) := (others=>'0');
...
SIGNAL ADRB_buf : STD_LOGIC_VECTOR(9 downto 0) := (others=>'0');
SIGNAL ADRB_mout : STD_LOGIC_VECTOR(9 downto 0) := (others=>'0');
...
SIGNAL RMB_buf: STD_LOGIC_VECTOR(3 downto 0);
  ...
  for uut : generic_vhd_SNPS_RF_SP_UHS_1Kx80 use entity work.generic_vhd_SNPS_RF_SP_UHS_1Kx80(behav);
  BEGIN
  ...
  uut : generic_vhd_SNPS_RF_SP_UHS_1Kx80
  generic map (
        NW                     => 1024, 
        NADDR                  => 10,
        rmbits                 => 3,
  ...
  port map (
   ...
   t3b_me => t3b_me
    ...
    ADRA_buf(8) <= 'X' when ADRA(8) = 'Z' else  ADRA(8);
    ADRA_buf(9) <= 'X' when ADRA(9) = 'Z' else  ADRA(9);
    ...
    ADRB_buf(8) <= 'X' when ADRB(8) = 'Z' else  ADRB(8);
    ADRB_buf(9) <= 'X' when ADRB(9) = 'Z' else  ADRB(9);
...
configuration conf_SNPS_RF_SP_UHS_1Kx80_behaviour of SNPS_RF_SP_UHS_1Kx80 is
for behaviour
end for;
end conf_SNPS_RF_SP_UHS_1Kx80_behaviour;
