...
--  Date of Generation : Fri Dec 09 16:07:50 CET 2022                  
--                                                                     
-----------------------------------------------------------------------
--   --------------------------------------------------------------     
...
entity generic_vhd_SNPS_RF_DP_HD_256x80 is
  generic (
        words             : integer                := 256;
        addrbits          : integer                := 8;
        bits              : integer                := 80;
...
end generic_vhd_SNPS_RF_DP_HD_256x80;

architecture behav of generic_vhd_SNPS_RF_DP_HD_256x80 is
...
entity SNPS_RF_DP_HD_256x80 is
...
end SNPS_RF_DP_HD_256x80;

architecture behaviour of SNPS_RF_DP_HD_256x80 is

component generic_vhd_SNPS_RF_DP_HD_256x80
  generic (
        words             : integer                := 256;
        addrbits          : integer                := 8;
        bits              : integer                := 80;
...
SIGNAL RMB_buf: STD_LOGIC_VECTOR(3 downto 0);
  ...
  for uut : generic_vhd_SNPS_RF_DP_HD_256x80 use entity work.generic_vhd_SNPS_RF_DP_HD_256x80(behav);
  BEGIN
  ...
  uut : generic_vhd_SNPS_RF_DP_HD_256x80
  generic map (
        NW                     => 256, 
        NADDR                  => 8,
        rmbits                 => 3,
...
configuration conf_SNPS_RF_DP_HD_256x80_behaviour of SNPS_RF_DP_HD_256x80 is
for behaviour
end for;
end conf_SNPS_RF_DP_HD_256x80_behaviour;
