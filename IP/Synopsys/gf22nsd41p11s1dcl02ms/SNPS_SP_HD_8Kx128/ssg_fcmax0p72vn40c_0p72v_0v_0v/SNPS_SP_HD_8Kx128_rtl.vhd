...
entity generic_vhd_SNPS_SP_HD_8Kx128 is
  generic (
        words            : integer            := 8192;
        addrbits         : integer            := 13;
        bits             : integer            := 128;
...
end generic_vhd_SNPS_SP_HD_8Kx128;

architecture behav of generic_vhd_SNPS_SP_HD_8Kx128 is
...
SIGNAL  ADR_old : std_logic_vector(12 downto 0);
SIGNAL  D_old : std_logic_vector(127 downto 0);
...
process( CLK, D, BC0, BC1, BC2, TEST_RNM, TEST1, t3_me)
   ...
   VARIABLE ADRlatched : std_logic_vector(12 downto 0);
   VARIABLE Dlatched : std_logic_vector(127 downto 0);
...
procedure trash_mem(mem_core_array : inout ram_array) is
 variable word_line : std_logic_vector (127 downto 0);
 begin
...
end SNPS_SP_HD_8Kx128;

architecture behaviour of SNPS_SP_HD_8Kx128 is

component generic_vhd_SNPS_SP_HD_8Kx128
  generic (
        words             : integer                := 8192;
        addrbits          : integer                := 13;
        bits              : integer                := 128;
...
SIGNAL ADR_buf : STD_LOGIC_VECTOR(12 downto 0) := (others=>'0');
SIGNAL ADR_mout : STD_LOGIC_VECTOR(12 downto 0) := (others=>'0');
SIGNAL D_buf : STD_LOGIC_VECTOR(127 downto 0) := (others=>'0');
SIGNAL D_mout : STD_LOGIC_VECTOR(127 downto 0) := (others=>'0');
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_8Kx128 use entity work.generic_vhd_SNPS_SP_HD_8Kx128(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_8Kx128
  generic map (
        NW                     => 8192, 
        NADDR                  => 13,
        rmbits                 => 3,
...
configuration conf_SNPS_SP_HD_8Kx128_behaviour of SNPS_SP_HD_8Kx128 is
for behaviour
end for;
end conf_SNPS_SP_HD_8Kx128_behaviour;
