...
entity generic_vhd_SNPS_SP_HD_256x32 is
  generic (
        words            : integer            := 256;
        addrbits         : integer            := 8;
        bits             : integer            := 32;
...
end generic_vhd_SNPS_SP_HD_256x32;

architecture behav of generic_vhd_SNPS_SP_HD_256x32 is
...
end SNPS_SP_HD_256x32;

architecture behaviour of SNPS_SP_HD_256x32 is

component generic_vhd_SNPS_SP_HD_256x32
  generic (
        words             : integer                := 256;
        addrbits          : integer                := 8;
        bits              : integer                := 32;
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_256x32 use entity work.generic_vhd_SNPS_SP_HD_256x32(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_256x32
  generic map (
        NW                     => 256, 
        NADDR                  => 8,
        rmbits                 => 3,
...
configuration conf_SNPS_SP_HD_256x32_behaviour of SNPS_SP_HD_256x32 is
for behaviour
end for;
end conf_SNPS_SP_HD_256x32_behaviour;
