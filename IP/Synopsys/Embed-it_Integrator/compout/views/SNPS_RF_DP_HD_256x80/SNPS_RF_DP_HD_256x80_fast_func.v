...
`endif
generic_behav_SNPS_RF_DP_HD_256x80 #( MES_CNTRL, TCSEP) uut ( .QB(QB_mem), .ADRA(ADRA), .DA(DA), .WEA(WEA), .MEA(MEA), .CLKA(CLKA), .ADRB(ADRB), .MEB(MEB), .CLKB(CLKB) );
...
module generic_behav_SNPS_RF_DP_HD_256x80 (  QB, ADRA, DA, WEA, MEA, CLKA, ADRB, MEB, CLKB );
