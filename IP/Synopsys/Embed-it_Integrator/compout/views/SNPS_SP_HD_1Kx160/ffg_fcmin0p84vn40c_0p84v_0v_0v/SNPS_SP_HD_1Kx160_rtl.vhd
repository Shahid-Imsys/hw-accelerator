...
entity generic_vhd_SNPS_SP_HD_1Kx160 is
  generic (
        words            : integer            := 1024;
        addrbits         : integer            := 10;
        bits             : integer            := 160;
...
end generic_vhd_SNPS_SP_HD_1Kx160;

architecture behav of generic_vhd_SNPS_SP_HD_1Kx160 is
...
SIGNAL  D_old : std_logic_vector(159 downto 0);
...
process( CLK, D, BC0, BC1, BC2, TEST_RNM, TEST1, t3_me)
   ...
   VARIABLE Dlatched : std_logic_vector(159 downto 0);
...
procedure trash_mem(mem_core_array : inout ram_array) is
 variable word_line : std_logic_vector (159 downto 0);
 begin
...
end SNPS_SP_HD_1Kx160;

architecture behaviour of SNPS_SP_HD_1Kx160 is

component generic_vhd_SNPS_SP_HD_1Kx160
  generic (
        words             : integer                := 1024;
        addrbits          : integer                := 10;
        bits              : integer                := 160;
...
SIGNAL D_buf : STD_LOGIC_VECTOR(159 downto 0) := (others=>'0');
SIGNAL D_mout : STD_LOGIC_VECTOR(159 downto 0) := (others=>'0');
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for uut : generic_vhd_SNPS_SP_HD_1Kx160 use entity work.generic_vhd_SNPS_SP_HD_1Kx160(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  uut : generic_vhd_SNPS_SP_HD_1Kx160
  generic map (
        NW                     => 1024, 
        NADDR                  => 10,
        rmbits                 => 3,
  ...
  port map (
   ...
   t3_me => t3_me
    ...
    D_buf(64) <= 'X' when D(64) = 'Z' else  D(64);
    D_buf(65) <= 'X' when D(65) = 'Z' else  D(65);
    D_buf(66) <= 'X' when D(66) = 'Z' else  D(66);
    D_buf(67) <= 'X' when D(67) = 'Z' else  D(67);
    D_buf(68) <= 'X' when D(68) = 'Z' else  D(68);
    D_buf(69) <= 'X' when D(69) = 'Z' else  D(69);
    D_buf(70) <= 'X' when D(70) = 'Z' else  D(70);
    D_buf(71) <= 'X' when D(71) = 'Z' else  D(71);
    D_buf(72) <= 'X' when D(72) = 'Z' else  D(72);
    D_buf(73) <= 'X' when D(73) = 'Z' else  D(73);
    D_buf(74) <= 'X' when D(74) = 'Z' else  D(74);
    D_buf(75) <= 'X' when D(75) = 'Z' else  D(75);
    D_buf(76) <= 'X' when D(76) = 'Z' else  D(76);
    D_buf(77) <= 'X' when D(77) = 'Z' else  D(77);
    D_buf(78) <= 'X' when D(78) = 'Z' else  D(78);
    D_buf(79) <= 'X' when D(79) = 'Z' else  D(79);
    D_buf(80) <= 'X' when D(80) = 'Z' else  D(80);
    D_buf(81) <= 'X' when D(81) = 'Z' else  D(81);
    D_buf(82) <= 'X' when D(82) = 'Z' else  D(82);
    D_buf(83) <= 'X' when D(83) = 'Z' else  D(83);
    D_buf(84) <= 'X' when D(84) = 'Z' else  D(84);
    D_buf(85) <= 'X' when D(85) = 'Z' else  D(85);
    D_buf(86) <= 'X' when D(86) = 'Z' else  D(86);
    D_buf(87) <= 'X' when D(87) = 'Z' else  D(87);
    D_buf(88) <= 'X' when D(88) = 'Z' else  D(88);
    D_buf(89) <= 'X' when D(89) = 'Z' else  D(89);
    D_buf(90) <= 'X' when D(90) = 'Z' else  D(90);
    D_buf(91) <= 'X' when D(91) = 'Z' else  D(91);
    D_buf(92) <= 'X' when D(92) = 'Z' else  D(92);
    D_buf(93) <= 'X' when D(93) = 'Z' else  D(93);
    D_buf(94) <= 'X' when D(94) = 'Z' else  D(94);
    D_buf(95) <= 'X' when D(95) = 'Z' else  D(95);
    D_buf(96) <= 'X' when D(96) = 'Z' else  D(96);
    D_buf(97) <= 'X' when D(97) = 'Z' else  D(97);
    D_buf(98) <= 'X' when D(98) = 'Z' else  D(98);
    D_buf(99) <= 'X' when D(99) = 'Z' else  D(99);
    D_buf(100) <= 'X' when D(100) = 'Z' else  D(100);
    D_buf(101) <= 'X' when D(101) = 'Z' else  D(101);
    D_buf(102) <= 'X' when D(102) = 'Z' else  D(102);
    D_buf(103) <= 'X' when D(103) = 'Z' else  D(103);
    D_buf(104) <= 'X' when D(104) = 'Z' else  D(104);
    D_buf(105) <= 'X' when D(105) = 'Z' else  D(105);
    D_buf(106) <= 'X' when D(106) = 'Z' else  D(106);
    D_buf(107) <= 'X' when D(107) = 'Z' else  D(107);
    D_buf(108) <= 'X' when D(108) = 'Z' else  D(108);
    D_buf(109) <= 'X' when D(109) = 'Z' else  D(109);
    D_buf(110) <= 'X' when D(110) = 'Z' else  D(110);
    D_buf(111) <= 'X' when D(111) = 'Z' else  D(111);
    D_buf(112) <= 'X' when D(112) = 'Z' else  D(112);
    D_buf(113) <= 'X' when D(113) = 'Z' else  D(113);
    D_buf(114) <= 'X' when D(114) = 'Z' else  D(114);
    D_buf(115) <= 'X' when D(115) = 'Z' else  D(115);
    D_buf(116) <= 'X' when D(116) = 'Z' else  D(116);
    D_buf(117) <= 'X' when D(117) = 'Z' else  D(117);
    D_buf(118) <= 'X' when D(118) = 'Z' else  D(118);
    D_buf(119) <= 'X' when D(119) = 'Z' else  D(119);
    D_buf(120) <= 'X' when D(120) = 'Z' else  D(120);
    D_buf(121) <= 'X' when D(121) = 'Z' else  D(121);
    D_buf(122) <= 'X' when D(122) = 'Z' else  D(122);
    D_buf(123) <= 'X' when D(123) = 'Z' else  D(123);
    D_buf(124) <= 'X' when D(124) = 'Z' else  D(124);
    D_buf(125) <= 'X' when D(125) = 'Z' else  D(125);
    D_buf(126) <= 'X' when D(126) = 'Z' else  D(126);
    D_buf(127) <= 'X' when D(127) = 'Z' else  D(127);
    D_buf(128) <= 'X' when D(128) = 'Z' else  D(128);
    D_buf(129) <= 'X' when D(129) = 'Z' else  D(129);
    D_buf(130) <= 'X' when D(130) = 'Z' else  D(130);
    D_buf(131) <= 'X' when D(131) = 'Z' else  D(131);
    D_buf(132) <= 'X' when D(132) = 'Z' else  D(132);
    D_buf(133) <= 'X' when D(133) = 'Z' else  D(133);
    D_buf(134) <= 'X' when D(134) = 'Z' else  D(134);
    D_buf(135) <= 'X' when D(135) = 'Z' else  D(135);
    D_buf(136) <= 'X' when D(136) = 'Z' else  D(136);
    D_buf(137) <= 'X' when D(137) = 'Z' else  D(137);
    D_buf(138) <= 'X' when D(138) = 'Z' else  D(138);
    D_buf(139) <= 'X' when D(139) = 'Z' else  D(139);
    D_buf(140) <= 'X' when D(140) = 'Z' else  D(140);
    D_buf(141) <= 'X' when D(141) = 'Z' else  D(141);
    D_buf(142) <= 'X' when D(142) = 'Z' else  D(142);
    D_buf(143) <= 'X' when D(143) = 'Z' else  D(143);
    D_buf(144) <= 'X' when D(144) = 'Z' else  D(144);
    D_buf(145) <= 'X' when D(145) = 'Z' else  D(145);
    D_buf(146) <= 'X' when D(146) = 'Z' else  D(146);
    D_buf(147) <= 'X' when D(147) = 'Z' else  D(147);
    D_buf(148) <= 'X' when D(148) = 'Z' else  D(148);
    D_buf(149) <= 'X' when D(149) = 'Z' else  D(149);
    D_buf(150) <= 'X' when D(150) = 'Z' else  D(150);
    D_buf(151) <= 'X' when D(151) = 'Z' else  D(151);
    D_buf(152) <= 'X' when D(152) = 'Z' else  D(152);
    D_buf(153) <= 'X' when D(153) = 'Z' else  D(153);
    D_buf(154) <= 'X' when D(154) = 'Z' else  D(154);
    D_buf(155) <= 'X' when D(155) = 'Z' else  D(155);
    D_buf(156) <= 'X' when D(156) = 'Z' else  D(156);
    D_buf(157) <= 'X' when D(157) = 'Z' else  D(157);
    D_buf(158) <= 'X' when D(158) = 'Z' else  D(158);
    D_buf(159) <= 'X' when D(159) = 'Z' else  D(159);
...
configuration conf_SNPS_SP_HD_1Kx160_behaviour of SNPS_SP_HD_1Kx160 is
for behaviour
end for;
end conf_SNPS_SP_HD_1Kx160_behaviour;
