...
#
# Generated by Vivado on Wed Mar 30 15:35:20 CEST 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../gpp.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../gpp.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/markar/checkouts/ImSys/FPGA_syntheis_test/Processors/IM3000E/fpga_synth/gpp/gpp.cache/compile_simlib/vcs"
  fi
