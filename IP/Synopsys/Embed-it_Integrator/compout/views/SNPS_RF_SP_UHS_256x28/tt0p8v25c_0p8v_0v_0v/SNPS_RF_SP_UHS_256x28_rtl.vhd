...
--  Date of Generation : Thu Nov 10 09:50:35 CET 2022                  
--                                                                     
-----------------------------------------------------------------------
--   --------------------------------------------------------------     
...
entity generic_vhd_SNPS_RF_SP_UHS_256x28 is
  generic (
        words            : integer            := 256;
        addrbits         : integer            := 8;
        bits             : integer            := 28;
...
end generic_vhd_SNPS_RF_SP_UHS_256x28;

architecture behav of generic_vhd_SNPS_RF_SP_UHS_256x28 is
...
entity SNPS_RF_SP_UHS_256x28 is
...
end SNPS_RF_SP_UHS_256x28;

architecture behaviour of SNPS_RF_SP_UHS_256x28 is

component generic_vhd_SNPS_RF_SP_UHS_256x28
  generic (
        words             : integer                := 256;
        addrbits          : integer                := 8;
        bits              : integer                := 28;
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for u0 : generic_vhd_SNPS_RF_SP_UHS_256x28 use entity work.generic_vhd_SNPS_RF_SP_UHS_256x28(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  u0 : generic_vhd_SNPS_RF_SP_UHS_256x28
  generic map (
        NW                     => 256, 
        NADDR                  => 8,
        rmbits                 => 3,
...
configuration conf_SNPS_RF_SP_UHS_256x28_behaviour of SNPS_RF_SP_UHS_256x28 is
for behaviour
end for;
end conf_SNPS_RF_SP_UHS_256x28_behaviour;
