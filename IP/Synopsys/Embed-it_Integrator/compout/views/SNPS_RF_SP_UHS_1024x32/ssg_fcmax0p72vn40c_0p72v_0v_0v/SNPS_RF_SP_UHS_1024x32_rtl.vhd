...
entity generic_vhd_SNPS_RF_SP_UHS_1024x32 is
  generic (
        words            : integer            := 1024;
        addrbits         : integer            := 10;
        bits             : integer            := 32;
...
end generic_vhd_SNPS_RF_SP_UHS_1024x32;

architecture behav of generic_vhd_SNPS_RF_SP_UHS_1024x32 is
...
entity SNPS_RF_SP_UHS_1024x32 is
...
end SNPS_RF_SP_UHS_1024x32;

architecture behaviour of SNPS_RF_SP_UHS_1024x32 is

component generic_vhd_SNPS_RF_SP_UHS_1024x32
  generic (
        words             : integer                := 1024;
        addrbits          : integer                := 10;
        bits              : integer                := 32;
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for u0 : generic_vhd_SNPS_RF_SP_UHS_1024x32 use entity work.generic_vhd_SNPS_RF_SP_UHS_1024x32(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  u0 : generic_vhd_SNPS_RF_SP_UHS_1024x32
  generic map (
        NW                     => 1024, 
        NADDR                  => 10,
        rmbits                 => 3,
...
configuration conf_SNPS_RF_SP_UHS_1024x32_behaviour of SNPS_RF_SP_UHS_1024x32 is
for behaviour
end for;
end conf_SNPS_RF_SP_UHS_1024x32_behaviour;
