...
--  Date of Generation : Fri Dec 09 14:28:53 CET 2022                  
--                                                                     
-----------------------------------------------------------------------
--   --------------------------------------------------------------     
...
entity generic_vhd_SNPS_RF_SP_UHS_512x28 is
  generic (
        words            : integer            := 512;
        addrbits         : integer            := 9;
        bits             : integer            := 28;
...
end generic_vhd_SNPS_RF_SP_UHS_512x28;

architecture behav of generic_vhd_SNPS_RF_SP_UHS_512x28 is
...
SIGNAL  ADR_old : std_logic_vector(8 downto 0);
SIGNAL  D_old : std_logic_vector(27 downto 0);
...
process( CLK, D, BC0, BC1, BC2, TEST_RNM, TEST1, t3_me)
   ...
   VARIABLE ADRlatched : std_logic_vector(8 downto 0);
   VARIABLE Dlatched : std_logic_vector(27 downto 0);
...
procedure trash_mem(mem_core_array : inout ram_array) is
 variable word_line : std_logic_vector (27 downto 0);
 begin
...
entity SNPS_RF_SP_UHS_512x28 is
...
end SNPS_RF_SP_UHS_512x28;

architecture behaviour of SNPS_RF_SP_UHS_512x28 is

component generic_vhd_SNPS_RF_SP_UHS_512x28
  generic (
        words             : integer                := 512;
        addrbits          : integer                := 9;
        bits              : integer                := 28;
...
SIGNAL ADR_buf : STD_LOGIC_VECTOR(8 downto 0) := (others=>'0');
SIGNAL ADR_mout : STD_LOGIC_VECTOR(8 downto 0) := (others=>'0');
SIGNAL D_buf : STD_LOGIC_VECTOR(27 downto 0) := (others=>'0');
SIGNAL D_mout : STD_LOGIC_VECTOR(27 downto 0) := (others=>'0');
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for u0 : generic_vhd_SNPS_RF_SP_UHS_512x28 use entity work.generic_vhd_SNPS_RF_SP_UHS_512x28(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  u0 : generic_vhd_SNPS_RF_SP_UHS_512x28
  generic map (
        NW                     => 512, 
        NADDR                  => 9,
        rmbits                 => 3,
...
configuration conf_SNPS_RF_SP_UHS_512x28_behaviour of SNPS_RF_SP_UHS_512x28 is
for behaviour
end for;
end conf_SNPS_RF_SP_UHS_512x28_behaviour;
