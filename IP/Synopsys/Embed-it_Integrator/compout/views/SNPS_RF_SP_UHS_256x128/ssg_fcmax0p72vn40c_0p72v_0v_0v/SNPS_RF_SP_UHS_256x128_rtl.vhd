...
entity generic_vhd_SNPS_RF_SP_UHS_256x128 is
  generic (
        words            : integer            := 256;
        addrbits         : integer            := 8;
        bits             : integer            := 128;
...
end generic_vhd_SNPS_RF_SP_UHS_256x128;

architecture behav of generic_vhd_SNPS_RF_SP_UHS_256x128 is
...
SIGNAL  ADR_old : std_logic_vector(7 downto 0);
...
process( CLK, D, BC0, BC1, BC2, TEST_RNM, TEST1, t3_me)
   ...
   VARIABLE ADRlatched : std_logic_vector(7 downto 0);
...
entity SNPS_RF_SP_UHS_256x128 is
...
end SNPS_RF_SP_UHS_256x128;

architecture behaviour of SNPS_RF_SP_UHS_256x128 is

component generic_vhd_SNPS_RF_SP_UHS_256x128
  generic (
        words             : integer                := 256;
        addrbits          : integer                := 8;
        bits              : integer                := 128;
...
SIGNAL ADR_mout : STD_LOGIC_VECTOR(7 downto 0) := (others=>'0');
...
SIGNAL BC2_buf: STD_LOGIC;
  ...
  for u0 : generic_vhd_SNPS_RF_SP_UHS_256x128 use entity work.generic_vhd_SNPS_RF_SP_UHS_256x128(behav);
  BEGIN
 ...
 process ( CLK_buf,LS_buf1 )
  ...
  u0 : generic_vhd_SNPS_RF_SP_UHS_256x128
  generic map (
        NW                     => 256, 
        NADDR                  => 8,
        rmbits                 => 3,
...
configuration conf_SNPS_RF_SP_UHS_256x128_behaviour of SNPS_RF_SP_UHS_256x128 is
for behaviour
end for;
end conf_SNPS_RF_SP_UHS_256x128_behaviour;
