...
//  Date of Generation : Fri Dec 09 14:35:23 CET 2022                  
//                                                                     
//---------------------------------------------------------------------
//   --------------------------------------------------------------     
...
module SNPS_RF_DP_UHD_512x80 ( QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, TEST_RNMA, RMEA, RMA, WA, WPULSE, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
begin
  ...
  begin
    ...
    begin
      $display("<<VIRL_MEM_WARNING: RMA[3] is unknown>> at time=%t; instance=%m (SNPS_RF_DP_UHD_512x80_core)",$realtime);
    end
  end
end
always @(RMB_buf[3])
begin
  ...
  begin
    if( (MES_CNTRL=="ON"|| MES_CNTRL=="WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING: RMB[3] is unknown>> at time=%t; instance=%m (SNPS_RF_DP_UHD_512x80_core)",$realtime);
    end
  end
end
...
module generic_behav_SNPS_RF_DP_UHD_512x80 (  QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, TEST_RNMA, RMEA, RMA, WA, WPULSE, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB );

`else

module generic_behav_SNPS_RF_DP_UHD_512x80 (  QB, ADRA, DA, WEA, MEA, CLKA, TEST1A, TEST_RNMA, RMEA, RMA, WA, WPULSE, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB, CLKB_tcq,notif_adra, notif_da, notif_wea, notif_mea, notif_clka, notif_clkap, notif_clka_CLKB_rise_rise_rec, notif_test1a, notif_test_rnma, notif_rmea, notif_rma, notif_wa, notif_wpulse, notif_ls_a, notif_ls_b, notif_adrb, notif_meb, notif_clkb, notif_clkbp, notif_clkb_CLKA_rise_rise_rec, notif_test1b, notif_rmeb, notif_rmb );
